...
if (isset($_GET['codigo_pedido'])) {
    ...
    if ($result_pedido->num_rows > 0) {
        ...
        while ($row_pedido = $result_pedido->fetch_assoc()) {
            ...
            ?>
            <?php
            // Consulta SQL para obter todas as informações do Cliente com base no nome do cliente
            $sql_cliente = "SELECT * FROM cliente WHERE nomeCliente = '$nome_cliente'";
            $result_cliente = $conexao->query($sql_cliente);

            if ($result_cliente->num_rows > 0) {
                // Exibe os detalhes do cliente
                while ($row_cliente = $result_cliente->fetch_assoc()) {
                    // Aqui você pode acessar os detalhes do cliente, por exemplo:
                    $idCliente = $row_cliente["idCliente"];
                    $cpfCliente = $row_cliente["cpfCliente"];
                    // Faça o que precisar com essas informações
                }
            } else {
                // Caso não haja cliente com o nome fornecido
                echo "Nenhum Cliente encontrado com o nome fornecido: $nome_cliente";
            }
            ?>
            ...
            <body>
                ...
                <?php
                include_once 'conexao.php';
                $sql4 = "SELECT nome, cnpj, email, telefone FROM `informacoes`";
                ...
                <div class="container1">
                    <div class="retangulo">
                        ...
                        if (mysqli_num_rows($resultado) > 0) {
                            ...
                            echo '<img src="upload-imagens/' . $imagem . '" alt="Logo da Empresa">';
                        } else {
                        ...
                        <div class="header">
                            ...
                            <p><b>Documento:
                                    ...
                                    if (empty($cpfCliente)) {
                                        ...
                                        // Exibir os primeiros 5 dígitos do CPF seguidos por '*'
                                        $cpf_oculto = substr($cpfCliente, 0, 9) . '*****';
                                        echo $cpf_oculto;
                                    }
                                    ?>
                        ...
                        <div class="details">
                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    $sql_itens = "SELECT produto_id, nome_produto, quantidade, valor_unitario FROM itens_pedido WHERE codigo_pedido = $codigo_pedido";
