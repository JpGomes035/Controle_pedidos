...
<body>
    <div style="padding:20px 0;max-width:800px" class="container">
        ...
        <form action="inserir_banco.php" method="POST">
            ...
            <div class="form-group">
                <label for="cc">Valor total:</label>
                <input type="number" class="form-control" id="valor_banco" placeholder="Valor total no banco"  step="0.01" name="valor_banco"autocomplete="off">
            </div>
