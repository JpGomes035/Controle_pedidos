...
<div style="padding:20px 0;max-width:800px" class="container">
    <h4 style="padding:0 0 20px 0;margin-bottom:35px;" class="border-bottom">Informações Sobre o Pagamento:</h4>
    <form action="atualizar_info_pagamento.php" method="POST">
        <?php
        $sql = "SELECT * FROM pedido_compra WHERE codigo_pedido = $codigo_pedido";
        ...
        ?>
            ...
            <div class="form-group">
                <label for="Cod_pedido">Código do Pedido</label>
            ...
            <div class="form-group">
                <label for="Cod_pedido">Responsável: (Não permitido alterar)</label>
