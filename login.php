...
<body>
    ...
    // Supondo que $conexao seja a conexão com o seu banco de dados
    ...
    ?>
                <div class="container">
                    ...
                    <form action="logar.php" method="POST">
                        ...
                        <br>
                        <p class="justify-content-center">Faça aqui um agendamento! <span style="width:5px"></span><a href="agenda_externa.php">Clique aqui</a></p>
                    </form>
                </div>
            </body>
</html>